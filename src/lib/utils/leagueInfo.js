/*   STEP 1   */
export const leagueID = "989226609821429760"; // your league ID
export const leagueName = "Degen Dynasty"; // your league name
...
export const managers = [
  ...
  // }
      ...
      "managerID": "8602425183469568008",  // the user's manager ID, go to https://api.sleeper.app/v1/league/<your_league_id>/users to find user IDs (you can use older leagueIDs to find user IDs for managers that are no longer in the league)
      "name": "Your Name",
